...
export const editorReviewsData: EditorReview[] = [
  ...
  },
  {
    ...
    providerId: "zzoomm",
    score: 9.2,
    verdict: "The absolute best value alternative network for central Wiltshire, offering complete price freezes.",
    ...
    metaDescription: "Symmetric gigabit plans starting from £27.95/month. Read our deep-dive review of Zzoomm's fibre network in Devizes and Calne.",
    ...
    introCopy: "Zzoomm has built proprietary networks across Devizes, Calne, and Melksham, providing a genuine high speed alternative to standard telephone cables.",
    postcodeTargets: ["SN10", "SN11", "SN12"],
    townTargets: ["devizes", "calne", "melksham"],
    primaryKeyword: "Zzoomm broadband review Wiltshire",
    secondaryKeywords: ["Zzoomm speed test Devizes", "Zzoomm price freeze review", "best broadband Calne"],
    faqItems: [
      {
    ...
    ogDescription: "Why Zzoomm's fixed price lock makes it our top-rated Wiltshire altnet.",
